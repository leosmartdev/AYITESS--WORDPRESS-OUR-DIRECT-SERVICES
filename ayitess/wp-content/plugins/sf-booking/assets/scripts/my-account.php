...
<h2><?php echo (!empty($service_finder_options['label-profile-settings'])) ? esc_html($service_finder_options['label-profile-settings']) : esc_html__('Profile Settings', 'service-finder'); ?></h2>
    ...
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            <label>
            <?php esc_html_e('Project Name', 'service-finder'); ?>
            </label>
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-user"></i>
        ...
        <div class="col-lg-12">
          <div class="form-group">
            <label>
            <?php esc_html_e('Genres', 'service-finder'); ?>
            </label>
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-user"></i>
    ...
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label>
            <?php esc_html_e('Whatsapp number', 'service-finder'); ?>
            </label>
  ...
  <div class="panel panel-default service-perform-here" style="display:none;">
    <div class="panel-heading sf-panel-heading">
    ...
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label>
            <?php esc_html_e('Spotify', 'service-finder'); ?>
            </label>
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-spotify sf-color-social"></i>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label>
            <?php esc_html_e('Soundcloud', 'service-finder'); ?>
            </label>
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-soundcloud sf-color-social"></i>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-lock"></i>
              <input type="password" class="form-control sf-form-control" name="password" id="password" value="">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fixed-w fa fa-lock"></i>
              <input type="password" class="form-control sf-form-control" name="confirm_password" id="confirm_password" value="">
            </div>
          </div>
        </div>
        <div class="col-md-12">
...
<?php
  ...
  <div class="panel panel-default attachment-files">
    <div class="panel-heading sf-panel-heading">
      <h3 class="panel-tittle m-a0"><span class="fa fa-paperclip"></span> <?php esc_html_e('Press Kit', 'service-finder'); ?> </h3>
    </div>
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        <div class="col-md-12">
  ...
  <div class="panel panel-default embeded-code">
    <div class="panel-heading sf-panel-heading">
      <h3 class="panel-tittle m-a0"><span class="fa fa-code"></span> <?php esc_html_e('Videos & Musics', 'service-finder'); ?> </h3>
    </div>
    <div class="panel-body sf-panel-body padding-30">
      <div class="row">
        <div class="col-md-12">
