...
add_action( 'wp_ajax_load-city-result', 'service_finder_load_city_result' );
add_action( 'wp_ajax_nopriv_load-city-result', 'service_finder_load_city_result' );

function service_finder_load_city_result() {
   ...
   $providersInfoArr = $getProviders->service_finder_getProvidersCities(esc_attr($_POST['cityid']),$start,$per_page,$orderby,$order);
